...
handler.help = handler.command = ['paretro', 'retrolga', 'plumy', 'burikin', 'sepia', 'duotone', 'blackwhite', 'sketch', 'sketchril', 'oils', 'esragan', 'watercolor', 'galaxy', 'freplace', 'rainbow', 'solarize', 'pinkbir']
handler.tags = ['effect']
handler.limit = 1
