let handler = async (m, {
  ...
  try {
    ...
    conn.reply(res, `Halo semuanya👋\n\nSaya adalah Yoshida, whatsapp bot yang siap membantu kamu mendapatkan data, informasi, mendownload media, dll hanya melalui whatsapp\n\nBot akan keluar otomatis setelah masa aktif habis\n*TimeOut* : *${msToDate(db.data.chats[res].expired - now)}*`, null, {
      mentions: [d]
    })
  } catch (e) {
    console.log(e)
